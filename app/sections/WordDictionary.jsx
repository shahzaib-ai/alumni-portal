...
export default function WordDictionary() {
  return (
    <>
      <div className="py-16">
        <ul class="space-y-4 sm:grid sm:grid-cols-1 sm:gap-6 sm:space-y-0 lg:grid-cols-3 lg:gap-8">
          <li>
            <div class="p-6 text-left rounded-lg xl:px-10">
              <div class="space-y-2">
                <div class="space-y-2 xl:flex xl:items-center xl:justify-between">
                  <div class="font-medium text-lg leading-6 space-y-1">
                    <div class="flex justify-center">
                      <h3 class="font-bold text-xl w-auto h-auto">
                        Find Your Mentor
                      </h3>
                    </div>
                    <div class="flex justify-center px-10 py-4">
                      <Image src={logo} alt="MentorCruise" />
                    </div>
                    <div>
                      <p class="my-4 text-base text-center">
      ...
      <div className="flex flex-col items-center bg-primary my-12 py-24 text-white">
        ...
        <h4 class="pt-5 pb-12 text-center mx-2">
